...
list.of.packages <- c('data.table', 'tidyverse', 'lubridate', 'readabs', 'readrba', 'tsibble', 'ggridges', 'modelr', 'yardstick', "ggplot2", "dplyr")
...
# Specify the series_id
series_id <- "A84423050A"

# Use get_series_info function to get information about the series
