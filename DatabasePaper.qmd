...
This paper describes large-scale Australian macroeconomic databases in the monthly and quarterly frequency. The dataset contains hundres of Australian and international economic indicators observed since YYYY. It is designed to be updated regularly and publicaly available with the goal of establishing a convenient starting point for empirical analysis that requires "big data".
